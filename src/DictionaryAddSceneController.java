 ...
 * methods of the FXML objects within the add mode scene. This scene is
 * displayed when the user inputs a new word into the dictionary.
 */
public class DictionaryAddSceneController {
	...
	@FXML
	/*
	 * Initializes the FXML objects within the add mode scene with the desired
	 * attributes
	 */
	...
	@FXML
	/*
	 * Handles the event when the save button is pressed. Adds the inputed word and
	 * its definition to the dictionary
	 */
