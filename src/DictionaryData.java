...
/**
 * DictionaryData class for managing the dictionary logic and storing the
 * dictionary data.
 */
public class DictionaryData {
	...
	/*
	 * Gets the singleton instance of DictionaryData for consistent usage across
	 * classes
	 */
	...
	/*
	 * Adds a new word to the dictionary if the provided word and definition are not
	 * empty. If the word already exists, its definition will be updated.
	 */
	...
	public void autoFill() {
		addWord("Apple", "A round fruit with shiny red or green skin " + "that is fairly hard and white inside.");
		addWord("Applejack",
				"a strong alcoholic drink made from cider " + "(= an alcoholic drink made from the juice of apples).");
		...
		addWord("Moona",
				"the epitome of cuteness and charm, a creature so delightful that "
